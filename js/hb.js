(() => {
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/gohugoio/hugo-mod-jslibs-dist/popperjs/v2@v2.21100.20000/package/dist/cjs/popper.js
  var require_popper = __commonJS({
    "ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/gohugoio/hugo-mod-jslibs-dist/popperjs/v2@v2.21100.20000/package/dist/cjs/popper.js"(exports) {
      "use strict";
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/henrygd/bigger-picture@v1.1.14/dist/bigger-picture.umd.js
  var require_bigger_picture_umd = __commonJS({
    "ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/henrygd/bigger-picture@v1.1.14/dist/bigger-picture.umd.js"(exports, module) {
...
`;
  ...
  var announcement_bar = { expand_stall_threshold: 1e3, interval: 5e3 };
  var back_to_top = { animation: true, icon_height: "2em", icon_name: "airplane", icon_width: "2em", position_bottom: "1rem", position_end: "1rem" };
  var bigger_picture = { play_interval: 5e3 };
  var blog = { archives: { paginate: 30 }, full_width: false, home: { featured_posts: 5, main_sections: ["posts"], pinned_posts_position: "list", taxonomies: false }, list_cols_lg: 3, list_cols_md: 2, paginate: 10, post_date_format: ":date_long", post_thumbnail: true, post_thumbnail_default: "https://fc.sinaimg.cn/large/005Czbxjgy1hlwfzqds5ij3334222wt9.jpg", post_thumbnail_placeholder: "\u8BE5\u6587\u7AE0\u8FD8\u6CA1\u5B9A\u4E49\u56FE\u7247", related_posts: { number: 10 }, sidebar: { position: "start", posts: { featured_count: 5, fill: true, list_style: "slide", recent_count: 5, style: "underline" }, profile: { avatar: "/images/avatar.png", avatar_size: 100, company: "", description: "\u559C\u9A6C\u62C9\u96C5\u7684\u5C71\u9876\u6C38\u8FDC\u4E0D\u4F1A\u6709\u4E07\u5BB6\u706F\u706B", location: "China\xB7HangZhou", socials: { bilibili: "477276392", email: "beilanzhisen@163.com" }, title: "\u4EBA\u95F4\u53EA\u662F\u6625" }, sticky: true, taxonomies: { count: true, limit: 10, separate: false, style: "underline" }, width: 0.35 }, toc: { position: "end" }, twikoo: { env_id: "https://twikoo.mletter.cn/", js_url: "https://cdn.bootcdn.net/ajax/libs/twikoo/1.6.16/twikoo.all.min.js" } };
  var breadcrumb = { disabled: false };
  var css_bundle_name = "hb";
  var docs = { date_format: ":date_long" };
  var featured_image = { size: "x640" };
  var footer = { description: "\u4E00\u4E2A\u5C0F\u7AD9", powered_by: true };
  var google_fonts = { display: "swap", families: [{ name: "Fira Sans" }, { axis: { ital: ["1"], wght: ["600"] }, name: "Fira Sans" }] };
  var header = { banner: { alignment: "center", img: "https://fc.sinaimg.cn/large/005Czbxjgy1hlwfzqds5ij3334222wt9.jpg" }, brand: "\u4EBA\u95F4\u53EA\u662F\u6625", breakpoint: "lg", full_width: true, logo_bg: "indigo", menus_alignment: "center", socials: { gmail: "beilanzhisen@163.com", zhihu: "--30-5-71-87" }, sticky: true };
  var heading_sign = { containers: { ".hb-blog-post-content": {}, ".hb-docs-doc-content": {} }, symbol: "#" };
  ...
  var progress_bar = { height: "5px", initial_width: 20, interval: 50, time: 2 };
  ...
  var params_default = { announcement_bar, back_to_top, bigger_picture, blog, breadcrumb, css_bundle_name, docs, featured_image, footer, google_fonts, header, heading_sign, js_bundle_name, logo, modules, pagination, progress_bar, scrollbar, styles, terms };

  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/announcement-bar@v0.4.1/assets/hb/modules/announcement-bar/js/index.ts
  (() => {
    let activeItem = 0;
    let timer = 0;
    let expandTimeout = 0;
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      const setTimer = () => {
        ...
        }, announcement_bar.interval ?? 5e3);
      };
      const expanding = () => {
        clearExpandTimeout();
        expandTimeout = setTimeout(() => {
          bar.classList.add("active");
        }, announcement_bar.expand_stall_threshold ?? 1e3);
      };
      setTimer();
      const bar = document.querySelector(".hb-announcement-bar");
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/slide@v0.3.1/assets/hb/modules/slide/js/index.ts
  (() => {
    "use strict";
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/progress-bar@v0.1.0/assets/hb/modules/progress-bar/js/progress.ts
  var Progress = class {
    ele;
    bar;
    width;
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/progress-bar@v0.1.0/assets/hb/modules/progress-bar/js/index.ts
  (() => {
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/base@v0.4.1/assets/hb/modules/base/js/responsive-table.ts
  (() => {
    "use strict";
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/dom/data.js
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/util/index.js
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/dom/event-handler.js
  var namespaceRegex = /[^.]*(?=\..*)\.|.*/;
  var stripNameRegex = /\..*/;
  var stripUidRegex = /::\d+$/;
  var eventRegistry = {};
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/dom/manipulator.js
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/util/config.js
  var Config = class {
    // Getters
    static get Default() {
      return {};
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/base-component.js
  var VERSION = "5.3.2";
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/dom/selector-engine.js
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/collapse.js
  var NAME = "collapse";
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/tab.js
  var NAME2 = "tab";
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/util/swipe.js
  var NAME3 = "swipe";
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/carousel.js
  var NAME4 = "carousel";
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/carousel@v0.2.4/assets/hb/modules/carousel/js/index.ts
  (() => {
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/dropdown.js
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/util/backdrop.js
  var NAME6 = "backdrop";
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/util/component-functions.js
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/util/focustrap.js
  var NAME7 = "focustrap";
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/util/scrollbar.js
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.2+incompatible/js/src/offcanvas.js
  var NAME8 = "offcanvas";
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/header@v0.12.3/assets/hb/modules/header/js/index.ts
  (() => {
    document.addEventListener("DOMContentLoaded", () => {
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/heading-sign@v0.2.0/assets/hb/modules/heading-sign/js/index.ts
  (() => {
    document.addEventListener("DOMContentLoaded", () => {
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/bigger-picture@v0.9.2/assets/hb/modules/bigger-picture/js/panel.ts
  var Panel = class {
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/back-to-top@v0.1.2/assets/hb/modules/back-to-top/js/button.ts
  var Button = class {
    btn;
    constructor(icon) {
  ...
  (() => {
    ...
    window.addEventListener("DOMContentLoaded", () => {
      const btn = new Button(`<svg aria-hidden="true" class="bi bi-airplanebi bi-airplane hi-svg-inline hb-back-to-top-icon" fill="currentColor" height="2em" viewBox="0 0 16 16" width="2em" xmlns="http://www.w3.org/2000/svg">
...
(() => {
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/i18n-js@v0.2.1/assets/mods/i18n/translator.ts
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/code-block-panel@v0.5.0/assets/mods/code-block-panel/js/i18n.ts
  var i18n = new Translator(params_default.i18n, params_default.defaultLang);
  var i18n_default = i18n;

  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hugomods/code-block-panel@v0.5.0/assets/mods/code-block-panel/js/panel.ts
  var Panel = class {
    constructor(code) {
      this.code = code;
    }
