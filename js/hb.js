...
`;
  ...
  // ns-hugo:/Users/sourner/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/iframe@v0.1.1/assets/hb/modules/iframe/js/index.ts
  (() => {
    document.querySelectorAll(".hb-iframe-load-btn").forEach((btn) => {
      btn.addEventListener("click", () => {
        const parent = btn.parentElement;
        const iframe = parent.nextElementSibling;
        const btnFullscreen = parent.querySelector(".hb-iframe-fullscreen");
        const loadInfo = parent.querySelector(".hb-iframe-load-info");
    ...
    document.querySelectorAll(".hb-iframe-fullscreen").forEach((btn) => {
      btn.addEventListener("click", () => {
        const wrapper = btn.closest(".hb-iframe-wrapper");
        const iframe = wrapper.querySelector(".hb-iframe");
  ...
  var header = { brand: "\u4EBA\u95F4\u53EA\u662F\u6625", breakpoint: "lg", full_width: true, logo_bg: "indigo", menus_alignment: "end", socials: { gmail: "beilanzhisen@163.com", zhihu: "--30-5-71-87" }, sticky: true };
